...
```bash
mkdir -p ~/.terraform.d/plugins/registry.terraform.io/infobloxopen/nios/2.1.0/<OS_ARCH>(linux_amd64, darwin_amd64, windows_amd64)
mv terraform-provider-nios ~/.terraform.d/plugins/registry.terraform.io/infobloxopen/nios/2.1.0/<OS_ARCH>
```
...
```bash
xattr -d com.apple.quarantine ~/.terraform.d/plugins/registry.terraform.io/infobloxopen/nios/2.1.0/<OS_ARCH>/terraform-provider-nios
```
