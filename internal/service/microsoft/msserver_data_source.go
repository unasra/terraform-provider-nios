...
func (m *MsserverModelWithFilter) FlattenResults(ctx context.Context, from []microsoft.Msserver, diags *diag.Diagnostics) {
	if len(from) == 0 {
		return
	}
...
func (d *MsserverDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Retrieves information about existing Microsoft Servers.",
...
func (d *MsserverDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	allResults, err := utils.ReadWithPages(
		func(pageID string, maxResults int32) ([]microsoft.Msserver, string, error) {
