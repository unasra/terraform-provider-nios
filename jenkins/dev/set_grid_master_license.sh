...
# set_grid_master_license.sh
# Automates temp license activation and CA cert check disabling on a NIOS Grid Master.
#
# Usage:
#   ./set_grid_master_license.sh <host_url>
#
# Example:
#   ./set_grid_master_license.sh 192.0.2.1
#
# Requires: expect

if [ $# -ne 1 ]; then
    echo "Usage: $0 <host_url>" >&2
    echo "Example: $0 192.0.2.1  # Grid Master host/IP" >&2
    exit 1
fi
